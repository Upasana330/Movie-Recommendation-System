...
📘 PROJECT_GUIDE.md - Training setup and configurations
📡 API Reference
Endpoints
...
📖 Documentation: Check PROJECT_GUIDE.md for detailed guides
🎓 Training Help: See training/guide.md for model training
